...
public class AnnotationController {
	...
	@RequestMapping("/annotation/param2")
	...
	@RequestMapping("/annotation/param3")
	public String param3(Model model, String uid, int age, String name, String hp) {
	...
	public String model(ModelDTO dto) {
